package com.david.practice.splash;
...
import com.david.practice.GuideActivity;
import com.david.practice.NotifyPractice;
import com.david.practice.PropertyAnimatorPractice;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case SWITCH_MAINACTIVITY:
                    mIntent = new Intent();
                    mIntent.setClass(SplashActivity.this, InternetActivity.class);
